    ...
    <div className="min-h-screen bg-[var(--paper)] text-ink">
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-6 pt-10 sm:px-10">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-[480px] text-[17px] leading-relaxed text-ink-body sm:text-[19px]">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-3">
          {/* Steg 1 */}
          <div className="rounded-[20px] border border-[var(--line-soft)] bg-white p-6 shadow-[var(--shadow-card)]">
            <div className="mb-5 flex h-[96px] items-center justify-center">
              <svg width="120" height="88" viewBox="0 0 120 88" fill="none" aria-hidden="true">
                <rect x="4" y="10" width="42" height="54" rx="8" fill="#f0ebe2" stroke="#e0d8ca" strokeWidth="1.2"/>
                <rect x="11" y="17" width="28" height="22" rx="4" fill="#e0d8ca"/>
                <circle cx="25" cy="29" r="8" fill="#c8bfb4"/>
                <rect x="11" y="44" width="28" height="5" rx="2.5" fill="#e0d8ca"/>
                <path d="M52 37 L62 37" stroke="#FF6A00" strokeWidth="2" strokeLinecap="round"/>
                <path d="M58 33 L62 37 L58 41" stroke="#FF6A00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="66" y="10" width="50" height="60" rx="10" fill="white" stroke="#ece4d6" strokeWidth="1.5" strokeDasharray="5 3"/>
                <path d="M91 28 L91 46 M84 40 L91 47 L98 40" stroke="#FF6A00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="77" y="20" width="28" height="5" rx="2.5" fill="#ece4d6"/>
              </svg>
            </div>
          ...
          <div className="rounded-[20px] border border-[var(--line-soft)] bg-white p-6 shadow-[var(--shadow-card)]">
            <div className="mb-5 flex h-[96px] items-center justify-center">
              <svg width="120" height="88" viewBox="0 0 120 88" fill="none" aria-hidden="true">
                <defs>
                  <pattern id="illu-checker-2" x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
                  ...
                  <clipPath id="illu-clip-2">
                    <rect x="70" y="10" width="46" height="60" rx="8"/>
                  </clipPath>
                </defs>
                <rect x="4" y="10" width="44" height="60" rx="8" fill="#dce8f0" stroke="#c8d8e4" strokeWidth="1.2"/>
                <rect x="13" y="20" width="26" height="36" rx="5" fill="#b8d4e8"/>
                <rect x="13" y="16" width="26" height="8" rx="3" fill="#a0bfd4"/>
                <circle cx="60" cy="39" r="10" fill="#fbe7d6" stroke="#FF6A00" strokeWidth="1.5"/>
                <path d="M56 39 L60 35 L64 39 M60 35 L60 43" stroke="#FF6A00" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="70" y="10" width="46" height="60" rx="8" fill="url(#illu-checker-2)" stroke="#ece4d6" strokeWidth="1.2"/>
                <rect x="79" y="20" width="28" height="36" rx="5" fill="#1a1512" fillOpacity="0.12" clipPath="url(#illu-clip-2)"/>
                <rect x="79" y="16" width="28" height="8" rx="3" fill="#1a1512" fillOpacity="0.1" clipPath="url(#illu-clip-2)"/>
                <circle cx="112" cy="14" r="7" fill="#FF6A00"/>
                <path d="M109 14 L111.5 16.5 L115 12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          ...
          <div className="rounded-[20px] border border-[var(--line-soft)] bg-white p-6 shadow-[var(--shadow-card)]">
            <div className="mb-5 flex h-[96px] items-center justify-center">
              <svg width="120" height="88" viewBox="0 0 120 88" fill="none" aria-hidden="true">
                <defs>
                  <pattern id="illu-checker-3" x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
                    <rect width="4" height="4" fill="#e9ebee"/>
                    <rect x="4" y="0" width="4" height="4" fill="#f7f8f9"/>
                    <rect x="0" y="4" width="4" height="4" fill="#f7f8f9"/>
                    <rect x="4" y="4" width="4" height="4" fill="#e9ebee"/>
                  </pattern>
                  <clipPath id="illu-clip-3">
                    <rect x="4" y="10" width="82" height="62" rx="10"/>
                  </clipPath>
                </defs>
                <rect x="4" y="10" width="82" height="62" rx="10" fill="url(#illu-checker-3)" stroke="#ece4d6" strokeWidth="1.2"/>
                <rect x="14" y="18" width="24" height="42" rx="5" fill="#1a1512" fillOpacity="0.13" clipPath="url(#illu-clip-3)"/>
                <rect x="14" y="15" width="24" height="8" rx="3" fill="#1a1512" fillOpacity="0.1" clipPath="url(#illu-clip-3)"/>
                <line x1="44" y1="34" x2="44" y2="46" stroke="#9e9e9e" strokeWidth="1.8" strokeLinecap="round"/>
                <line x1="38" y1="40" x2="50" y2="40" stroke="#9e9e9e" strokeWidth="1.8" strokeLinecap="round"/>
                <rect x="52" y="18" width="26" height="42" rx="5" fill="#1a1512" fillOpacity="0.13" clipPath="url(#illu-clip-3)"/>
                <rect x="52" y="15" width="26" height="8" rx="3" fill="#1a1512" fillOpacity="0.1" clipPath="url(#illu-clip-3)"/>
                <rect x="6" y="12" width="28" height="14" rx="4" fill="white" fillOpacity="0.92"/>
                <text x="20" y="22" fontFamily="monospace" fontSize="8" fill="#FF6A00" textAnchor="middle">PNG</text>
                <rect x="94" y="24" width="22" height="28" rx="8" fill="white" stroke="#FF6A00" strokeWidth="1.5"/>
                <path d="M105 31 L105 42 M101 39 L105 43 L109 39" stroke="#FF6A00" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="98" y="48" width="14" height="2.5" rx="1.25" fill="#FF6A00"/>
              </svg>
            </div>
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-16 sm:px-10">
        <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:items-center sm:gap-7 sm:text-left">
          ...
          <div className="flex w-full flex-col items-center gap-2.5 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-3">
            {/* Shopify */}
            <span className="inline-flex items-center gap-2 rounded-full border border-[var(--line-soft)] bg-white/70 px-4 py-1.5 font-display text-[15px] font-medium text-[#6f675b] shadow-[var(--shadow-card)]">
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-16 sm:px-10 sm:pb-24">
        <div className="mb-8 flex flex-col gap-3 sm:mb-10 sm:flex-row sm:flex-wrap sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="font-display text-[34px] font-semibold tracking-[-0.03em] sm:text-[40px]">
              Från enskild butik till global e-handelsbyrå
            </h2>
          </div>
